                        ...
                        <table style={{ width: '100%', marginTop: '24px',border: '1px solid #AFEEEE' }}>
                            <thead style={{ backgroundColor: "#F0F5FF",textAlignLast:'center'}}>
                                <tr>
                                    ...
                                    <th style={{ padding: '12px 16px', textAlign: 'left', color:'#696969' }}>รหัสยา</th>
                                    ...
                                    <th style={{ padding: '12px 16px', textAlign: 'left', color:'#696969' }}>ราคารวม</th>
                            ...
                            <tbody>
                                ...
                                <td style={{ padding: '12px 16px' }}>px</td>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={40} sm={12} sx={{mt:10}}>
            {/* <Divider sx={{ borderColor: '#5698E0', borderWidth: 3, }} /> */}
                <Card>
                    <CardContent>
                        <Typography sx={{fontWeight:800}}>การรับยา/เวชภัณฑ์</Typography>
                        ...
                        <table style={{ width: '100%', marginTop: '24px',border: '1px solid #AFEEEE' }}>
                            <thead style={{ backgroundColor: "#F0F5FF",}}>
                                <tr>
                                    ...
                                    <th style={{ padding: '12px 16px', textAlign: 'left', color:'#696969' }}>ตัวแทน</th>
